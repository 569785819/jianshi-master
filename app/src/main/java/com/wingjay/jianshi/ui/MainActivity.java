...
import com.app.annotation.apt.Rounter;
import com.apt.TRouter;
import com.squareup.picasso.Picasso;
import com.wingjay.jianshi.Constants;
import com.wingjay.jianshi.R;
import com.wingjay.jianshi.RounterConstants;
...
import com.zzj.jianshi.aspect.annotation.MonitorLog;
import com.zzj.jianshi.widget.ActivityTransControl;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityTransControl.setTransView(v);
                TRouter.go(RounterConstants.EDIT);
            }
        });
        ...
        readerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityTransControl.setTransView(v);
                TRouter.go(RounterConstants.DIARY);
            }
        });
    ...
    protected void onPause() {
        super.onPause();
        Timber.e("testAspect() befor");
        testAspect();
        Timber.e("testAspect() after");
    }
    ...
    private void setImagePoem(ImagePoem imagePoem) {
        ...
        backgroundImage.setImageResource(R.mipmap.default_home_image);
    }
