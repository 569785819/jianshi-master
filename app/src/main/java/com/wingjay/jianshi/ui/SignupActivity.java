 ...
 * Signup Activity.
 */
@Rounter(RounterConstants.SIGNUP)
public class SignupActivity extends BaseActivity {
    ...
    void signUp() {
        ...
        ActivityTransControl.setTransView(signUpView);
    ...
    void login() {
        ...
        ActivityTransControl.setTransView(loginView);
    ...
    @OnClick(R.id.skip)
    void skip() {
        ActivityTransControl.setTransView(skip);
        TRouter.go(RounterConstants.MAIN);
    }
