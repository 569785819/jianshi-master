...
@Rounter(RounterConstants.DIARY)
public class DiaryListActivity extends BaseActivity implements DiaryListAdapter.RecyclerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diaryListView.setLayoutManager(new LinearLayoutManager(
    ...
    public void onItemClick(Diary diary) {
        ...
        TRouter.go(RounterConstants.VIEW,TRouter.getMap().addHead(diary.getUuid()));
    }
